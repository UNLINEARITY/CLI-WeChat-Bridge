...
export const messages: Record<string, string> = {
  ...
  "daemon.welcome": "WeChat Daemon ready.\nCWD: {cwd}\nActive: {adapter}\n\nCommands: /claude, /codex, /opencode, /pi, /stop, /confirm, /deny, /status, /model, /plan, /all <prompt>\n{bindings}\n\nManage: /bind [emoji] cmd, /unbind [emoji], /bindings",
  ...
  "doctor.label.wecomConnectivity": "WeCom connectivity",
  ...
  "doctor.credentialsMissingWecom": "not found (run wecom-setup first)",
