export const messages: Record<string, string> = {
  ...
  // === Daemon 欢迎 & 控制 ===
  "daemon.welcome": "微信 Daemon 就绪。\n工作目录: {cwd}\n当前: {adapter}\n\n命令: /claude, /codex, /opencode, /pi, /stop, /confirm, /deny, /status, /model, /plan, /all <prompt>\n{bindings}\n\n管理: /bind [表情] 命令, /unbind [表情], /bindings",
  ...
  "spawn.diagnostic.nodeVersion": "- 确保 Node.js >= 22.13.0: node --version",
  ...
  "doctor.label.wecomConnectivity": "企业微信服务可达性",
  ...
  "doctor.credentialsMissingWecom": "未找到 (先运行 wecom-setup)",
